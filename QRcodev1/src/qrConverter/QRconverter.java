...
public class QRconverter {
	...
	public void convertToQr(String stringToConvert) {

		String filePath = "/Users/Simon/Documents/testqr/Test1.png";
		int size = 250;
		String fileType = "png";
		File myFile = new File(filePath);
		try {

			// Based on ZXING open-source image processing library
			...
			BitMatrix byteMatrix = qrCodeWriter.encode(stringToConvert, BarcodeFormat.QR_CODE, size, size, hintMap);
